Результат дополнительного задания для HEAD and HEANDS. Приложение показывает на карте количество чекинов в определенных точках в виде графика. Сервер - heroku 
